...
export const crudResources = {
  ...
  campaigns: {
    ...
    fields: [
      ...
      { key: 'location', label: 'Lieu (carte)', type: 'text', placeholder: 'Ex. Gemena, Kinshasa, Brésil…' },
  ...
  testimonies: {
    ...
    fields: [
      ...
      { key: 'location', label: 'Lieu (carte)', type: 'text', placeholder: 'Ex. Gemena, Kinshasa, Montréal…' },
  ...
  hommages: {
    ...
    fields: [
      ...
      { key: 'location', label: 'Lieu (carte)', type: 'text', placeholder: 'Ex. Kinshasa, Ngaliema…' },
...
export const siteSections = [
  ...
  { key: 'carte', label: 'Carte', path: '/admin/carte', publicPath: '/carte', icon: 'map' },
  ...
  { key: 'inscriptions', label: 'Inscriptions', path: '/admin/inscriptions', publicPath: '/inscription', icon: 'inscriptions' },
