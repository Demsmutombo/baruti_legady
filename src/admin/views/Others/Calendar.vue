          ...
          >
            ...
            <div class="flex items-center gap-3 mt-6 modal-footer sm:justify-end">
              ...
              <button
                ...
                class="btn btn-success btn-update-event flex w-full justify-center rounded-lg bg-brand-500 px-4 py-2.5 text-sm font-medium text-deep-blue hover:bg-brand-600 sm:w-auto"
              >
...
import Modal from '@admin/components/profile/Modal.vue'
