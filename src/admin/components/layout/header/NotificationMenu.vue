<template>
  <div class="relative" ref="dropdownRef">
    ...
    >
      ...
      >
        <h5 class="text-lg font-semibold text-gray-800 dark:text-white/90">Activité du mémorial</h5>
        ...
        <li v-for="notification in notifications" :key="notification.id" @click="handleItemClick">
          ...
          >
            <span class="relative block w-full h-10 rounded-full z-1 max-w-10">
              <img :src="notification.userImage" alt="Notification" class="h-10 w-10 overflow-hidden rounded-full object-cover" />
              <span
...
const { adminNotifications } = useAdminSiteData()
...
const notifications = computed(() =>
  adminNotifications.value.map((item) => ({
    id: item.id,
